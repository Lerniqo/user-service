...
], users_controller_1.updateMyProfile);
...
], users_controller_1.changePassword);
router.post('/upload-photo', upload.single('profileImage'), users_controller_1.uploadProfilePhoto);
